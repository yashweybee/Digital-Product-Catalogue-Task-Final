...
import { setProductEditData } from "../../utils/stateSlice";
...
const Product = ({
  ...
  const productEditBtn = () => {
    // console.log(data);
    dispatch(setProductEditData(data));
    navigate("/admin");
  };
  ...
  return (
    <>
      ...
      <div className="relative m-2 mx-1  flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md cursor-pointer transition-all">
        <div
